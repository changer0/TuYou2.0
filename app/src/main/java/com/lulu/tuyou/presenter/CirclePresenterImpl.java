...
//    private void loadLocalTrackData() {
//        dbTrackHandler.getTracksFromDb();
//    }
//
...
//                            if (TuYouTrackDbHandler.DB_DATA_RECEIVE_STATE_SUCCESS == state) {
...
//                                            }
//                                        } else {
//                                            Toast.makeText(mContext, "数据库添加失败", Toast.LENGTH_SHORT).show();
//                                        }
//
//                                    }
//                                });
//                            } else {
//                                Toast.makeText(mContext, "数据库清空出错", Toast.LENGTH_SHORT).show();
//                            }
//
//                        }
//                    });
//
//                } else {
//                    Toast.makeText(mContext, "网络获取数据失败", Toast.LENGTH_SHORT).show();
...
//    public void onReceive(int type, List<TuYouTrack> tracks, int state) {
//        switch (type) {
//            case TuYouTrackDbHandler.DB_DATA_RECEIVE_TYPE_ADD:
//                break;
//            case TuYouTrackDbHandler.DB_DATA_RECEIVE_TYPE_GET_TRACKS:
//                if (TuYouTrackDbHandler.DB_DATA_RECEIVE_STATE_SUCCESS == state) {
//                    Collections.sort(tracks);
//                    mAdapter.setDataList(tracks);
//                } else {
//                    Toast.makeText(mContext, "数据库加载数据失败", Toast.LENGTH_SHORT).show();
//                }
//                break;
//            case TuYouTrackDbHandler.DB_DATA_RECEIVER_TYPE_CLEAR:
//                if (TuYouTrackDbHandler.DB_DATA_RECEIVE_STATE_SUCCESS == state) {
//                    dbTrackHandler.addTracks(list, new TuYouTrackDbHandler.OnDataReceiveListener() {
//
//                        @Override
